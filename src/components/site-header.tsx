        ...
        <header className="border-b bg-background/80 backdrop-blur sticky top-0 z-30">
            <div className="container mx-auto flex h-14 items-center justify-between px-4 gap-4">
                <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <span className="hidden text-xs text-muted-foreground sm:inline">магазин товаров для бани</span>
                </div>
                ...
                <nav className="hidden items-center gap-4 text-sm lg:flex flex-1 max-w-4xl">
                    ...
                    {navLinks.map((link) => {
                        ...
                        return (
                            ...
                            >
                                {link.label}
                                {isActive && <span className="absolute -bottom-1 left-0 right-0 h-0.5 bg-primary transition-all duration-200" />}
                            </Link>
                        )
                    })}
                    ...
                    <Link
                        ...
                        className={`relative transition-colors duration-200 ${
                            pathname === '/favorites' ? 'text-foreground font-medium' : 'text-muted-foreground hover:text-foreground'
                        }`}
                    >
                        <button
                            type="button"
