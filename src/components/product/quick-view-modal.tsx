...
function TabsWithScroll({
  ...
  return (
    <div className="flex flex-col min-h-0 h-full">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 pt-4 animate-in fade-in duration-200">
        {activeContent}
      </div>
    </div>
  );
...
export function QuickViewModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-5xl h-[90vh] flex flex-col rounded-lg border bg-background animate-in zoom-in duration-200"
            ...
            <div className="flex flex-col space-y-4 min-w-0">
              ...
              <div className="flex flex-col gap-2 pt-2 border-t flex-shrink-0">
                <Button
                  ...
                  className="w-full"
                  disabled={
                    (!product.is_custom_order && product.stock_quantity === 0) ||
                    justAdded
                  }
                >
                  {justAdded
