        ...
        <section className="space-y-6">
            <header className="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Управление товарами каталога.</p>
                </div>
                            ...
                            filteredItems.map((row) => (
                                <tr key={row.id} className="border-t">
                                        ...
                                        <div className="flex items-center gap-3">
                                            {row.main_image_url && (
                                                <div className="h-10 w-16 overflow-hidden rounded-md border bg-muted">
                                                    <img src={row.main_image_url} alt={row.name} className="h-full w-full object-cover" loading="lazy" />
                                                </div>
                                            )}
                                    ...
                                    <td className="px-3 py-3 text-xs">
                                        {row.is_active ? (
                                            <span className="rounded-full bg-emerald-50 px-2 py-0.5 text-[11px] text-emerald-700">Активен</span>
                                        ) : (
                                            <span className="rounded-full bg-muted px-2 py-0.5 text-[11px] text-muted-foreground">Скрыт</span>
                                        )}
                                    </td>
                                    ...
                                    <td className="px-3 py-3 text-right">
                                        <div className="flex justify-end gap-2">
                                            ...
                                            <Button size="icon-sm" variant="ghost" onClick={() => handleDelete(row.id)} disabled={saving}>
                                                ✕
                                            </Button>
                                        </div>
                                    </td>
