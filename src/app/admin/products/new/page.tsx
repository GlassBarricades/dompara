...
export default function NewProductPage() {
    ...
    async function loadNewProductAttributes(categoryId: string, subcategoryId: string | null) {
    ...
    return (
        <section className="space-y-6">
            <header className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Заполни карточку товара и характеристики. Товар можно будет скрыть от показа в каталоге.</p>
            </header>
                    ...
                    <>
                        ...
                        <div className="space-y-3 border-t pt-4 mt-4">
                            ...
                            {productAttributes.length === 0 && !attrsLoading && (
                                <p className="text-xs text-muted-foreground">
                                    Для выбранной категории/подкатегории ещё не назначены характеристики. Настрой их в разделе «Назначения характеристик».
                                </p>
                            )}
